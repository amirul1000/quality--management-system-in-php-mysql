...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="process"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/process/index'); ?>"><i class="icon_table"></i>Process</a></li>
<li <?php if($this->router->fetch_class()=="warehouse"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/warehouse/index'); ?>"><i class="icon_table"></i>Warehouse</a></li>
<li <?php if($this->router->fetch_class()=="workers"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/workers/index'); ?>"><i class="icon_table"></i>Workers</a></li>
