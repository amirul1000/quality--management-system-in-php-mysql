...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2021 at 12:17 AM
...
CREATE TABLE `process` (
  ...
  `raw_materials_qty_or_weight` varchar(64) DEFAULT NULL,
  `raw_materials_unit` varchar(64) DEFAULT NULL,
  `raw_materials_cost` varchar(64) DEFAULT NULL,
  `finished_goods` text DEFAULT NULL,
  `finished_goods_qty_or_weight` varchar(64) DEFAULT NULL,
  `finished_goods_unit` varchar(64) DEFAULT NULL,
  `finished_goods_cost` varchar(64) DEFAULT NULL,
  `lost_raw_material` text DEFAULT NULL,
  `lost_raw_qty_or_weight` varchar(64) DEFAULT NULL,
  `lost_raw_unit` varchar(64) DEFAULT NULL,
  `manpowers` varchar(64) DEFAULT NULL,
  `total_work` varchar(64) DEFAULT NULL,
  `tw_unit` varchar(64) DEFAULT NULL,
  `manpower_cost` varchar(64) DEFAULT NULL,
